...
CREATE UNIQUE INDEX IF NOT EXISTS "IX_TourList_TourCode_SortOrder" ON "TourList" ("TourCode", "SortOrder");
CREATE UNIQUE INDEX IF NOT EXISTS "IX_TourList_TourCode_PoiId" ON "TourList" ("TourCode", "PoiId");
CREATE INDEX IF NOT EXISTS "IX_TourList_IsPublic" ON "TourList" ("IsPublic");
CREATE INDEX IF NOT EXISTS "IX_TourList_OwnerUserId_IsPublic" ON "TourList" ("OwnerUserId", "IsPublic");
